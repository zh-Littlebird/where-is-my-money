...
description: 当用户需要根据文字或图片记账，或查询、修改、分析个人财务数据时使用。MVP 聚焦交易录入、交易查询、账户与预算分析、支出分类洞察；账单、存钱罐、标签、附件等能力归入第二阶段。
---
...
| `scripts/firefly_client.py insight-expense-category <TOKEN> <START> <END>` | 获取支出分类洞察 |
